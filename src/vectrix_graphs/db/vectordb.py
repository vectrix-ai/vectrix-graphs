...
class VectorDB:
        ...
        if type == "chromadb":
            ...
            if os.environ["ENV"] == "local":
                try:
                    ...
                    self.client = chromadb.HttpClient(
                        host="host.docker.internal", port=7777
                    )
            else:
                ...
                self.client = chromadb.HttpClient(
                    ...
                    settings=Settings(
                        ...
                        chroma_client_auth_credentials=os.environ[
            ...
            try:
                self.collection = self.client.create_collection(
                    ...
                    metadata={
                        "hnsw:space": "cosine"
                    },  # Instead of the default squared L2 distance
                )
    ...
    def similarity_search(self, query: str, k: int = 3):
        ...
        if self.type == "chromadb":
            ...
            documents = []
            for content, metadata, distance, id in zip(
                results["documents"][0],
                results["metadatas"][0],
                results["distances"][0],
                results["ids"][0],
